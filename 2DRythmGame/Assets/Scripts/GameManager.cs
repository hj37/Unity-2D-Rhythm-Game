...
{//싱글톤 기법으로 구현함
    ...
    void Update()
    {
        ...
        //한 번 빛나게 된 라인은 반족적으로 다시 어둡게 처리합니다.

        for(int i = 0;
            i < trailSpriteRenderers.Length; i++)
        {
    ...
    public void processJudge(judges judge, int noteType)
    {
        ...
        //MISS 판정을 받은 경우 콤보를 종료하고, 점수를 많이 깍습니다.
        ...
        //BAD 판정을 받은 경우 콤보를 종료하고 , 점수를 조금 깍습니다.
